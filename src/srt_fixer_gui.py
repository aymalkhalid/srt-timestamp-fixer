...
class SRTFixerGUI:
    ...
    def setup_window(self):
        ...
        self.root.geometry("1600x1200")  # Increased window size 2x
        self.root.minsize(1200, 800)      # Increased minimum size 2x
