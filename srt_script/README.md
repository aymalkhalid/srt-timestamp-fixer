...
> **Note**: The executable is the GUI version (`srt_fixer_gui.py`) compiled with all dependencies included. For other interfaces (CLI, Modern GUI, Web App), use the Python installation methods below.
